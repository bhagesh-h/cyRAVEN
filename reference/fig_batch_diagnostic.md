...
- facet_col:
  ...
  Column of `cells` splitting the embedding panel into one UMAP per
  level – the timepoint, typically. NULL, or a column with fewer than
  two levels, draws the single pooled embedding. Default `NULL`.
