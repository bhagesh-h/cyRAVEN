...
- panel_order:
  ...
  `"abundance"` orders panels common to rare; `"name"` groups them by
  the part of the panel name before the first comma – the cell type, for
  callers that name panels `"<population>, <marker>"` – and orders by
