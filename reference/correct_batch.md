...
CytoNorm does and what a whole-file map cannot do; see
[`align_quantiles_by_cluster()`](https://bhagesh-h.github.io/cyRAVEN/reference/align_quantiles_by_cluster.md).
`"cytonorm"` is accepted as a synonym for `"cluster"`, because that is
the name the method is known by.
