...
- [`immune_subset_spec()`](https://bhagesh-h.github.io/cyRAVEN/reference/immune_subset_spec.md)
...
- [`attach_absolute_cells()`](https://bhagesh-h.github.io/cyRAVEN/reference/attach_absolute_cells.md)
...
- [`write_suggested_config()`](https://bhagesh-h.github.io/cyRAVEN/reference/write_suggested_config.md)
...
- [`theme_panel_borders()`](https://bhagesh-h.github.io/cyRAVEN/reference/theme_panel_borders.md)
  : Panel borders and gutters for any faceted figure

- [`natural_cluster_factor()`](https://bhagesh-h.github.io/cyRAVEN/reference/natural_cluster_factor.md)
  : Order cluster labels k1, k2, ... k30 rather than k1, k10, k11, ...
  k2
