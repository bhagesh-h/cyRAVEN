...
| `is_control` | `TRUE` for a control tube. Controls are read and used as references but excluded from between-group tests. |
...
the [Options reference](options.html). One section belongs here, because it is
about the sheet:
