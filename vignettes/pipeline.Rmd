---
title: "How it works: the ten stages"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How it works: the ten stages}
...
all. See [Explore mode](explore.html).

# Further reading

- [Running cyRAVEN](usage.html), for every command and option.
- [Inputs](inputs.html), for the sample sheet and the config.
