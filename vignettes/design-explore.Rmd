---
title: "Why explore mode is built the way it is"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Why explore mode is built the way it is}
...
- [Explore mode](explore.html): how to run it
- [Statistics](statistics.html): why the donor is the unit of replication
- [Interoperability](with-cycondor.html): handing a cyCONDOR clustering back
- [Scope](scope.html): nine excluded methods and the conditions for each
