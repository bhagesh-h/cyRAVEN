...
| `marker_umaps_by_group/` | One full-size UMAP per marker, in its own folder. Split by group where a group column resolves to two or more groups (`umap_CD3_by_timepoint.png`), one panel per marker where it does not (`umap_CD3.png`) |
